...
##  **Methodology**
The analysis was conducted using a structured data analytics workflow in Power BI, applying 
1. Power Query for data transformation 
2. data modelling to establish relationships between fact and dimension tables
3. DAX measures for calculations and 
4. Interactive visualizations using shapes, colours and slicers for dashboard.
